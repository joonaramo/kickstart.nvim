...
vim.keymap.set('n', '<leader>Q', vim.diagnostic.setqflist, { desc = 'Open diagnostic [Q]uickfix list (all files)' })
...
vim.keymap.set('n', '<leader>gl', '<cmd>Git log --oneline -100<CR>', { desc = '[G]it [L]og' })
vim.keymap.set('n', '<leader>gh', '<cmd>0Gclog<CR>', { desc = '[G]it file [H]istory' })
...
-- NOTE: These keymaps are now handled by vim-tmux-navigator plugin
-- which enables seamless navigation between tmux panes and vim splits
